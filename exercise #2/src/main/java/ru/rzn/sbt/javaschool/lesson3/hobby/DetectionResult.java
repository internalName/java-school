...
final public class DetectionResult {
    ...
    public DetectionResult(int pureStudentsCount, int rockstarsCount, int bikersCount) {
        if(pureStudentsCount!=0) this.pureStudentsCount = pureStudentsCount;
        if(rockstarsCount!=0) this.rockstarsCount = rockstarsCount;
        if(bikersCount!=0) this.bikersCount = bikersCount;
    }
